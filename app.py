...
[data-testid="stFileUploader"] {{ transform: translate({DROPZONE_X}px, {DROPZONE_Y}px) !important; background-color: transparent !important; border: none !important; padding: 0 !important; box-shadow: none !important; width: {DROPZONE_W} !important; min-width: {DROPZONE_W} !important; }}
    [data-testid="stFileUploadDropzone"] {{ background-color: {btn_bg} !important; border: 1px solid {border_color} !important; border-radius: 8px !important; height: {LINK_IMG_H} !important; display: flex !important; justify-content: center !important; align-items: center !important; position: relative !important; overflow: hidden !important; }}
    [data-testid="stFileUploadDropzone"] small, [data-testid="stFileUploadDropzone"] span, [data-testid="stFileUploadDropzone"] svg {{ display: none !important; opacity: 0 !important; }}
    [data-testid="stFileUploadDropzone"] > div:first-child {{ width: 100% !important; height: 100% !important; display: flex !important; }}
    [data-testid="stFileUploadDropzone"] button {{ position: absolute !important; top: 0 !important; left: 0 !important; width: 100% !important; height: 100% !important; opacity: 0 !important; z-index: 10 !important; cursor: pointer !important; }}
    [data-testid="stFileUploadDropzone"]::after {{ content: "📸 Upload Photos" !important; position: absolute !important; top: 50% !important; left: 50% !important; transform: translate(-50%, -50%) !important; color: {c_dash} !important; font-size: 16px !important; font-weight: 700 !important; z-index: 1 !important; pointer-events: none !important; }}
            ...
            if not table_data:
                ...
                st.dataframe(
                    ...
                    column_config={
                        ...
                        " P&L": st.column_config.Column(width="large")
                    }
                )
