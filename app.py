...
with col_t: 
    ...
    st.markdown('<div id="btn-abrir-menu" style="position: absolute; top: -5px; left: 0px; font-size: 90px; font-weight: 1200; color: #718096; cursor: pointer; z-index: 999999; letter-spacing: -4px;">»</div>', unsafe_allow_html=True)
