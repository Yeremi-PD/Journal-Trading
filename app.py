...
with col_cal:
    if paso_cuenta:
        ...
        with c_p2: st.markdown(f'<div style="{e_caja_p}"><div style="font-size: 25px; font-weight: 700; color: gray;">Total Withdrawn</div><div style="color: #00C897; font-size: 26px; font-weight: 800;">${total_retirado:,.2f}</div></div>', unsafe_allow_html=True)
