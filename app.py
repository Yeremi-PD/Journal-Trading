...
st.markdown(f"""
    ...
    div[data-testid="stSelectbox"] div[data-baseweb="select"] * {{ font-size: {OPT_FILTROS_SIZE}px !important; color: FFFFFF !important; }}
    div[data-testid="stSelectbox"] div[data-baseweb="select"] svg {{ fill: FFFFFF !important; color: FFFFFF !important; }}
